...
| :--: | :---: | :--- | :--- |
| **TP 6** | **Cemerlang** | Ketepatan ≥ 96% dan Purata Masa ≤ 4.0s | Menguasai sifir dengan cermat, tepat, cekap, dan **sangat pantas**. |
| **TP 5** | **Sangat Mahir** | Ketepatan ≥ 90% dan Purata Masa ≤ 7.0s | Melaksanakan kemahiran sifir dengan cermat, tepat, cekap, dan **pantas**. |
| **TP 4** | **Mahir** | Ketepatan ≥ 80% dan Purata Masa ≤ 15.0s | Melaksanakan kemahiran sifir dengan cekap dan **tepat** dalam had masa yang berpatutan. |
| **TP 3** | Boleh Mengaplikasi | Ketepatan ≥ 70% | Mengaplikasikan kefahaman, tetapi perlukan latihan kepantasan dan ketepatan. |
| **TP 2** | Faham | Ketepatan ≥ 50% | Memahami konsep, tetapi banyak jawapan salah dan perlu tingkatkan kelajuan. |
| **TP 1** | Tahu | Ketepatan < 50% | Perlu ulangkaji fakta asas sifir dan pengukuhan. |
